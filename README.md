...
<p align="center">
  <img alt="Light" src="https://github.com/maberyick/CellDiversityRao/blob/main/images/raster_Rao_plot.png" width="42%">
&nbsp; &nbsp; &nbsp; &nbsp;
  <img alt="Dark" src="https://github.com/maberyick/CellDiversityRao/blob/main/images/Rplot0.png" width="48%">
&nbsp; &nbsp; &nbsp; &nbsp;
...
The R file wsi_cell_plots, contains examples of how to plot in R the cell position and identifier from the json files. The cell were identified on a H&E image using the [Hover-Net](https://github.com/vqdang/hover_net) approach. The files then were saved in json files. 

<p align="center">
  <img alt="Light" src="https://github.com/maberyick/CellDiversityRao/blob/main/images/cell_type_v1.png" width="42%">
</p>
...
Duccio Rocchini, Matteo Marcantonio, Carlo Ricotta, Measuring Rao's Q diversity index from remote sensing: An open source solution, Ecological Indicators, Volume 72, 2017, Pages 234-238, ISSN 1470-160X. [doi.org/10.1016/j.ecolind.2016.07.039.](https://www.sciencedirect.com/science/article/pii/S1470160X16304319)
